...
- Added immutable RawArchive, reviewed source contracts, Source Observatory, schema/profile/scope cycles and scoped reanalysis.
- Added generic current-report persistence/analytics and local read models/API.
...
- Frozen workbook v9 and project source manifests.
