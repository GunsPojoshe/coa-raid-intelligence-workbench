...
def test_versioned_argentum_capture_reviews_on_platform_checkout(
    tmp_path: Path,
) -> None:
    ...
    assert isinstance(binding["contract_line_endings_normalized"], bool)
    assert isinstance(binding["access_line_endings_normalized"], bool)
